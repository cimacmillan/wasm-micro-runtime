...
WASMTIME_SSP_PASSTHROUGH_SOCKET_OPTION(set_send_buf_size, uint64)
WASMTIME_SSP_PASSTHROUGH_SOCKET_OPTION(get_send_buf_size, uint64 *)
WASMTIME_SSP_PASSTHROUGH_SOCKET_OPTION(set_recv_buf_size, uint64)
WASMTIME_SSP_PASSTHROUGH_SOCKET_OPTION(get_recv_buf_size, uint64 *)
...
WASMTIME_SSP_PASSTHROUGH_SOCKET_OPTION(set_tcp_fast_open_connect, uint8)
WASMTIME_SSP_PASSTHROUGH_SOCKET_OPTION(get_tcp_fast_open_connect, uint8 *)
...
__wasi_errno_t wasmtime_ssp_sock_ip_add_membership(     
#if !defined(WASMTIME_SSP_STATIC_CURFDS)
    struct fd_table *curfds,
#endif                 
    __wasi_fd_t sock,            
...
{                                                                  
    ...
    ret = os_socket_ip_add_membership(fd_number(fo), &ip_mreq);            
    fd_object_release(fo);                                         
    if (BHT_OK != ret)                                             
        return convert_errno(errno);                               
    return __WASI_ESUCCESS;                                        
...
__wasi_errno_t wasmtime_ssp_sock_ip_drop_membership(     
#if !defined(WASMTIME_SSP_STATIC_CURFDS)
    struct fd_table *curfds,
#endif                 
    __wasi_fd_t sock,            
...
{                                                                  
    ...
    ret = os_socket_ip_drop_membership(fd_number(fo), &ip_mreq);            
    fd_object_release(fo);                                         
    if (BHT_OK != ret)                                             
        return convert_errno(errno);                               
    return __WASI_ESUCCESS;                                        
