...
__wasi_errno_t wasmtime_ssp_sock_set_tcp_fast_open_connect(
#if !defined(WASMTIME_SSP_STATIC_CURFDS)
    struct fd_table *curfds,
#endif
    __wasi_fd_t sock,
    uint8_t enable
) WASMTIME_SSP_SYSCALL_NAME(sock_set_tcp_fast_open_connect) __attribute__((__warn_unused_result__));

__wasi_errno_t wasmtime_ssp_sock_get_tcp_fast_open_connect(
#if !defined(WASMTIME_SSP_STATIC_CURFDS)
    struct fd_table *curfds,
#endif
    __wasi_fd_t sock,
    uint8_t *enabled 
) WASMTIME_SSP_SYSCALL_NAME(sock_get_tcp_fast_open_connect) __attribute__((__warn_unused_result__));
...
) WASMTIME_SSP_SYSCALL_NAME(sock_ip_add_membership) __attribute__((__warn_unused_result__));
...
__wasi_errno_t wasmtime_ssp_sock_ip_drop_membership(
    ...
    __wasi_fd_t sock,
    __wasi_bh_ip_mreq_t *mreq
) WASMTIME_SSP_SYSCALL_NAME(sock_ip_drop_membership) __attribute__((__warn_unused_result__));
